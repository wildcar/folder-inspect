...
var messages = map[string]map[string]string{
	RU: {
		...
		"ui.q_restore_done":        "Возвращено: %d, проблем: %d",
		...
		"ui.apply_confirm":         "Переместить в карантин %d объектов (%s)?\n\nФайлы не удаляются: они переезжают в папку .folder-inspect/quarantine внутри репозитория, на их месте остаются файлы-заглушки с пояснением. Вернуть всё можно командой restore.",
		"ui.apply_running":         "Выполняю…",
		"ui.apply_result":          "Результат применения",
		"ui.apply_summary":         "перемещено: %d, заглушек: %d, проблем: %d",
		...
		"apply.summary":            "Перемещено: %d, заглушек: %d, проблем: %d",
	...
	EN: {
		...
		"ui.q_restore_done":        "Restored: %d, problems: %d",
		...
		"ui.apply":                 "Apply plan",
		"ui.apply_confirm":         "Move %d items (%s) to quarantine?\n\nNothing is deleted: files move to the .folder-inspect/quarantine folder inside the repository and a stub file with an explanation stays in their place. Everything can be brought back with the restore command.",
		"ui.apply_running":         "Applying…",
		"ui.apply_result":          "Apply result",
		"ui.apply_summary":         "moved: %d, stubs: %d, problems: %d",
		...
		"apply.summary":            "Moved: %d, stubs: %d, problems: %d",
